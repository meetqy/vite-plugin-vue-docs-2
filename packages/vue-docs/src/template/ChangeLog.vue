<template>
  <section>
    ...
    <div class="card">
      ...
      <ul>
        <li>生成文档时，新增<code>使用说明</code></li>
        <li>生成文档是，新增<code>更新日志</code></li>
        <li>可自定义网站名称</li>
      </ul>
      <h4 id="perf">Perf</h4>
      <ul>
    ...
    <div class="card">
      ...
      <ul>
        <li>
          修复
          <a
            href="https://github.com/meetqy/vite-plugin-vue-docs/issues/3"
            target="_blank"
            >#3, F5 刷新返回首页</a
          >
        </li>
        <li>修复 /docs 页面被用户内容所覆盖</li>
        <li>修复 <code>vite build</code>打包没有路由</li>
      </ul>
    </div>
    <div class="card">
      <h3 id="v0.1.4">v0.1.4</h3>
      ...
      <ul>
        <li>优化<code>jest badge</code>生成</li>
        <li>删除多余代码</li>
      </ul>
    </div>
    <div class="card">
    ...
    <div class="card">
      <h3 id="v0.1.1-v0.1.2">v0.1.1, v0.1.2</h3>
      <h4 id="feature-2">Feature</h4>
      <ul>
        <li>新增<code>transformMain</code>方法,可将 vue 转换为 html 文档</li>
        <li><code>hmr</code>文件改动无需 <code>F5</code>刷新</li>
      </ul>
      <h4 id="perf-3">Perf</h4>
      <ul>
        <li><code>hbs</code>模板改为<code>vue</code>模板</li>
        <li>服务器控制路由改为<code>vue-router</code></li>
      </ul>
    </div>
    <div class="card">
    ...
    <div class="card">
      ...
      <h4 id="feature-3">Feature</h4>
      <ul>
        <li>新增打开浏览器配置项</li>
        <li><code>lerna</code>管理项目</li>
      </ul>
    </div>
    <div class="card">
      <h3 id="v0.0.9">v0.0.9</h3>
      <h4 id="feature-4">Feature</h4>
      <ul>
      ...
      <h4 id="perf-4">Perf</h4>
      <ul>
        <li>简化开发环境配置与安装</li>
      </ul>
    </div>
    <div class="card">
      <h3 id="v0.0.8">v0.0.8</h3>
      <h4 id="feature-5">Feature</h4>
      <ul>
    ...
    <div class="card">
      ...
      <h4 id="perf-6">Perf</h4>
      <ul>
        <li>优化处理<code>ast</code>的结构</li>
        <li>优化代码格式化问题</li>
      </ul>
    </div>
    <div class="card">
    ...
    <div class="card">
      ...
      <h4 id="feature-6">Feature</h4>
      <ul>
        <li>兼容<code>export default {}</code>写法</li>
        <li>新增导航栏</li>
        <li>新增<code>header</code>头部</li>
      </ul>
      <h4 id="perf-7">Perf</h4>
      <ul>
        <li>优化开发环境</li>
        <li>hbs 模板用变量声明的字符串，改为文件方式</li>
        <li>优化 404 页面</li>
      </ul>
    </div>
    <div class="card">
      <h3 id="v0.0.4">v0.0.4</h3>
      <p>build 失误多升级了一个版本</p>
    </div>
    <div class="card">
      <h3 id="v0.0.3">v0.0.3</h3>
      <h4 id="feature-7">Feature</h4>
      <ul>
        <li>默认值解析</li>
      ...
      <h4 id="perf-8">Perf</h4>
      <ul>
        <li>类型显示为小写</li>
        <li>props 参数显示格式改为<code>xxx-xxx</code></li>
        <li>所有空的参数显示为<code>-</code></li>
      </ul>
    </div>
    <div class="card">
      <h3 id="v0.0.2">v0.0.2</h3>
      <h4 id="feature-8">Feature</h4>
      <ul>
        <li>启动时打印当前文档地址</li>
        <li>路由地址修改 HelloWord -&gt; /hello-world</li>
        <li>新增可配置路由前缀</li>
        <li>可监听文件修改/新增/删除</li>
      </ul>
